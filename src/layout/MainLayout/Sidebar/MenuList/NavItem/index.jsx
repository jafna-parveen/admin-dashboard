  ...
  return (
    <ListItemButton
      ...
      sx={{
        ...
        '&:hover': {
          backgroundColor: '#20425d !important',
    ...
    >
      <Box
        sx={{
          ...
          alignItems: 'center',
          gap: '10px',
          backgroundColor: isSelected ? '#537fa0 !important' : 'transparent',
          py: level > 1 ? 1 : 1,
          ...
          '& .MuiListItemIcon-root': {
            backgroundColor: isSelected ? 'white' : '#537fa0',
            borderRadius: '50%',
            p: 1,
            '& svg': {
              color: isSelected ? '#4e12e6' : 'white'
            }
          },
